...
export default function CustomCursor() {
    ...
    return (
        <div className="hidden lg:block">
            {/* The Main Dot */}
            <motion.div
                className="fixed top-0 left-0 w-2 h-2 bg-brand-yellow rounded-full pointer-events-none z-[9999]"
                style={{
                    x: mouseX,
                    y: mouseY,
                    translateX: "-50%",
            ...
            <motion.div
                ...
                animate={{
                    width: cursorType === 'magnifier' ? 96 : (isHovering ? 64 : 24),
                    height: cursorType === 'magnifier' ? 96 : (isHovering ? 64 : 24),
