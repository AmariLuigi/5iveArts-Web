    ...
    return (
        <div className="bg-[#050505] border border-white/5 rounded-sm shadow-2xl backdrop-blur-xl w-96 overflow-hidden flex flex-col">
            ...
            <div className="max-h-80 overflow-y-auto custom-scrollbar">
                {items.map((item) => (
                    <div key={item.product.id} className="p-4 flex gap-4 border-b border-white/[0.02] hover:bg-white/[0.01] transition-colors group relative">
                        ...
                        <div className="flex-1 min-w-0 flex flex-col justify-center">
                            ...
                            <div className="text-[9px] uppercase font-bold text-neutral-500 flex gap-2 mt-1 tracking-widest">
            ...
            <div className="p-6 bg-white/[0.02] border-t border-white/5">
                <div className="flex justify-between items-center mb-6">
                    <span className="text-[10px] uppercase font-black tracking-widest text-neutral-500">Subtotal</span>
