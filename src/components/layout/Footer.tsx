    ...
    <footer className="bg-black text-white border-t border-white/5 py-24 px-4 overflow-hidden">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12 lg:gap-24 relative z-10">
        ...
        <div className="space-y-8">
          ...
          <p className="text-[10px] uppercase font-black tracking-widest leading-relaxed text-neutral-600">
            {dict.footer.description}
          </p>
          <div className="flex gap-4">
            <button className="w-10 h-10 bg-white/[0.02] border border-white/5 flex items-center justify-center hover:bg-brand-yellow hover:text-black transition-all rounded-sm"><Instagram className="w-4 h-4" /></button>
            <button className="w-10 h-10 bg-white/[0.02] border border-white/5 flex items-center justify-center hover:bg-brand-yellow hover:text-black transition-all rounded-sm"><Facebook className="w-4 h-4" /></button>
          </div>
        </div>

        {/* Discovery Column */}
        <div className="space-y-8">
          <h4 className="text-[8px] uppercase font-black tracking-[0.4em] text-neutral-600 mb-8">{dict.nav.discovery}</h4>
        ...
        {/* Account Column */}
        <div className="space-y-8">
          <h4 className="text-[8px] uppercase font-black tracking-[0.4em] text-neutral-600 mb-8">{dict.nav.terminal}</h4>
        ...
        {/* Region Column */}
        <div className="space-y-8">
          <h4 className="text-[8px] uppercase font-black tracking-[0.4em] text-neutral-600 mb-8">{dict.nav.regional}</h4>
          ...
          <p className="text-[8px] uppercase font-black tracking-[0.4em] text-neutral-800">{dict.footer.logistics}</p>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto mt-24 pt-10 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-8">
        <span className="text-[8px] uppercase font-black tracking-[0.5em] text-neutral-800">
          {dict.footer.rights}
        </span>
        <div className="flex gap-10 text-[8px] uppercase font-black tracking-[0.5em] text-neutral-800">
