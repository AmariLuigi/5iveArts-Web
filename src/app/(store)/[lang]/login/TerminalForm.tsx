            ...
            <div className="w-full max-w-md z-10">
                ...
                <div className="bg-[#0a0a0a] border border-white/5 p-8 rounded-sm shadow-2xl relative overflow-hidden">
                    ...
                    <form onSubmit={handleAuth} className="space-y-6">
                        ...
                        <div className="relative group">
                            {/* Hidden Google SDK Button Overlay */}
                            <div id="google-auth-overlay" className="absolute inset-0 opacity-0 z-20 cursor-pointer overflow-hidden [&_iframe]:!w-full [&_iframe]:!h-full [&_iframe]:!scale-[5] [&_iframe]:!cursor-pointer" />
                            
                            <button
                                type="button"
                                disabled={loading}
                                className="w-full bg-white/[0.03] border border-white/10 py-5 rounded-sm font-black text-[10px] uppercase tracking-[0.2em] flex items-center justify-center gap-3 group-hover:bg-white/[0.06] group-hover:border-white/20 transition-all pointer-events-none"
                            >
                                <svg className="w-4 h-4 text-brand-yellow" viewBox="0 0 24 24">
                                    <path
                                        fill="currentColor"
