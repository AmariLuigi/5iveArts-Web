            ...
            <div className="max-w-3xl mx-auto">
                ...
                {existingApp && existingApp.status === 'pending' ? (
                    <div className="bg-[#050505] border border-white/5 p-12 text-center rounded-sm">
                        ...
                        <h3 className="text-xl font-black uppercase tracking-widest text-white mb-2">{dict.account.candidacyReview}</h3>
                        <p className="text-[10px] font-black uppercase tracking-widest text-neutral-600 mb-6 italic tabular-nums">
                            {dict.account.submittedOn} {new Date(existingApp.created_at).toLocaleDateString()}
                        </p>
                    ...
                    <PartnerApplyForm lang={lang} userEmail={user.email || ""} dict={dict} />
                )}
                ...
                <div className="mt-20 grid grid-cols-1 md:grid-cols-3 gap-8 pt-20 border-t border-white/5 opacity-50 grayscale hover:grayscale-0 transition-all">
                    <div className="space-y-3">
                        ...
                        <p className="text-[9px] font-black uppercase text-white tracking-widest">{dict.account.globalReach}</p>
                    ...
                    <div className="space-y-3">
                        ...
                        <p className="text-[9px] font-black uppercase text-white tracking-widest">{dict.account.partnerCommissions}</p>
                        <p className="text-[10px] font-bold text-neutral-600 leading-relaxed uppercase">
                    ...
                    <div className="space-y-3">
                        ...
                        <p className="text-[9px] font-black uppercase text-white tracking-widest">{dict.account.protocolProtected}</p>
                        <p className="text-[10px] font-bold text-neutral-600 leading-relaxed uppercase">
